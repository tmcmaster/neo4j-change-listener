package au.id.mcmaster.neo4j.changelistener;
...
import au.id.mcmaster.neo4j.changelistener.ChangeListenerKernelExtensionFactory;
...
public class ChangeListenerEventHandlerIntegrationTest {

    private GraphDatabaseService db;
    private final static Logger logger = Logger.getLogger(ChangeListenerEventHandlerIntegrationTest.class.getName());
